import { DAY_MAPPER, DEFAULT_WEEK_INDEXED } from "./constants";
...
export function getWeekOfMonth(date: Date, weekIndexed: WeekIndexed = DEFAULT_WEEK_INDEXED): WeekInfoResult {
