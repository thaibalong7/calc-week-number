...
function diffWeekOfTwoDate(date1, date2, weekIndexed = constants_1.ISO_WEEK_INDEXED) {
...
const getWeekNumberGenerator = (weekIndexed = constants_1.ISO_WEEK_INDEXED) => (date) => {
